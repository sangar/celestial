...
module Celestial
  class << self
    def for(options)
      ...
      y_sunrise = calculate(date - 1, latitude, longitude, :sunrise, 90.8333)
      y_sunset  = calculate(date - 1, latitude, longitude, :sunset, 90.8333)

      sunrise = calculate(date, latitude, longitude, :sunrise, 90.8333)
      sunset  = calculate(date, latitude, longitude, :sunset, 90.8333)
...

      {
        ...
        nautical: {
          sunrise: calculate(date, latitude, longitude, :sunrise, 102),
          sunset: calculate(date, latitude, longitude, :sunset, 102)
        },
        astronomical: {
          sunrise: calculate(date, latitude, longitude, :sunrise, 108),
          sunset: calculate(date, latitude, longitude, :sunset, 108)
        }
      }
    end
